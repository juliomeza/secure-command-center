...
LOGIN_REDIRECT_URL = os.environ.get('LOGIN_REDIRECT_URL', '/') # Redirect after successful social login (frontend URL)
LOGOUT_REDIRECT_URL = os.environ.get('LOGOUT_REDIRECT_URL', '/') # Redirect after logout (frontend URL)
